...
public class Biblioteca {
    ...
    public static void main(String[] args) {
        ...
        livro.add(new Livro("Bom", 1, "Edtor", 1995, "Cara"));
        livro.add(new Livro("hey", 2, "Edtor", 1999, "Vara"));
        livro.add(new Livro("mae", 4, "Remarker", 2003, "Cara"));
        livro.add(new Livro("primos", 1, "Redar", 1986, "Para"));
    ...
    static Livro cadastrarLivro() {
        ...
        book = new Livro(titulo, quantidade, editora, birth, Autor);
    ...
    static void realizarDevolucao() {
        ...
        for(Usuario user : usuario) {
            if(user.getId() == logado) {
                user.imprimirLivros(true);
            }
        }
